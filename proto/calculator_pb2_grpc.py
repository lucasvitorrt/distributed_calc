...
import proto.calculator_pb2 as calculator__pb2
...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Sqrt = channel.unary_unary(
                '/Calculator/Sqrt',
                request_serializer=calculator__pb2.OneNumber.SerializeToString,
                response_deserializer=calculator__pb2.Result.FromString,
                _registered_method=True)
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Sqrt': grpc.unary_unary_rpc_method_handler(
                    servicer.Sqrt,
                    request_deserializer=calculator__pb2.OneNumber.FromString,
                    response_serializer=calculator__pb2.Result.SerializeToString,
            ),
...
class Calculator(object):
    ...
    def Sqrt(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Calculator/Sqrt',
            calculator__pb2.OneNumber.SerializeToString,
            calculator__pb2.Result.FromString,
            options,
            channel_credentials,
            insecure,
